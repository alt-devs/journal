...
export class CreateCurrencyAndCompany1571765735269 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
      ...
      await queryRunner.query("INSERT INTO users(id, login, password, created_at, updated_at)" +
      ...
      await queryRunner.createIndex("currencies", new TableIndex({
        name: "idx_currencies_id",
        columnNames: ["id"],
        isUnique: true,
      }));

      await queryRunner.query("CREATE SEQUENCE currencies_id_seq;" +
      ...
      await queryRunner.query("CREATE SEQUENCE companies_id_seq;" +
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
      ...
      await queryRunner.query("DROP SEQUENCE IF EXISTS currencies_id_seq CASCADE;");
